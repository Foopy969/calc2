namespace calc
{
    ...
    {
        public int anim_overlays { get; set; }
        ...
        public int force_update_spectator_glow { get; set; }
        public int interface_engine_cvar { get; set; }
        public int is_c4_owner { get; set; }
        ...
        public int set_abs_angles { get; set; }
        public int set_abs_origin { get; set; }
    ...
    public class Netvars
    {
        ...
        public int m_angEyeAnglesX { get; set; }
        public int m_angEyeAnglesY { get; set; }
        ...
        public int m_bUseCustomAutoExposureMax { get; set; }
        public int m_bUseCustomAutoExposureMin { get; set; }
        public int m_bUseCustomBloomScale { get; set; }
        ...
        public int m_flCustomAutoExposureMax { get; set; }
        public int m_flCustomAutoExposureMin { get; set; }
        public int m_flCustomBloomScale { get; set; }
        ...
        public int m_flLastBoneSetupTime { get; set; }
        ...
        public int m_iMostRecentModelBoneCounter { get; set; }
